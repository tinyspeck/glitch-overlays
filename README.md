...
art and source for the game's overlays.
...
The original artwork, animations, and Flash source for the overlays that 
appeared while playing the game. Overlays encompass a broad variety of things
from the game — graphics for rook attacks, max quoin rainbows, and the letters
that appeared over players' heads on spelling streets are all examples of 
things you'll find in here.
